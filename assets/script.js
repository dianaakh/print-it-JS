...
const eventArrows = (index, slides) => {
	...
	arrowLeft.addEventListener('click', () => {
		...
		index = (index - 1 + slides.length) % slides.length // .length pour nb d'élements du tableau 
	...
	arrowRight.addEventListener('click', () => {
		...
		index = (index + 1) % slides.length // % opérateur modulo pour revenir a la première diapo : boucle
